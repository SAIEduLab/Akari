...
if(process.argv[2]==='--worker') {
  ...
  const html=version==='baseline'?cp.execFileSync('git',['show',baseline+':Akari.html'],{maxBuffer:4e6}).toString():fs.readFileSync('Akari.html','utf8');
  ...
  const base=loadApi(cp.execFileSync('git',['show',baseline+':Akari.html'],{maxBuffer:4e6}).toString());
