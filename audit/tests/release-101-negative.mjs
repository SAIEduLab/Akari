...
const baseline = "runtime() { appVersion: '1.0.0'; runtimeVersion: '1.0.0'; return 42; }";
const current = baseline.replace("appVersion: '1.0.0'", "appVersion: '1.0.1'");
verifyCompletedRuntime(current, baseline);
for (const changed of [current.replace('42','41'), current.replace("runtimeVersion: '1.0.0'", "runtimeVersion: '1.0.1'"), baseline])
