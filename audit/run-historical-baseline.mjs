...
import {completedCommit,completedManifestSha256,completedFixture,completedProduct,completedManifest,verifyFixedCore} from './lib/historical-release-baseline.mjs';
...
verifyFixedCore(report,before);console.log('Completed 1.0.0 fixed baseline: 884/884 PASS');
