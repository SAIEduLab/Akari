...
export function gateSteps(browser,dir) {
  ...
  return [
    ...
    ['fixed101','audit/run-fixed-baseline.mjs',browser,out('completed-baseline-selftest.json')],
    ['fixed101-features','audit/run-fixed-features.mjs',browser,out('fixed101-editor-assets.json')],
