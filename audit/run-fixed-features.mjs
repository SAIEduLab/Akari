...
import {completedCommit,completedFixture,completedProduct,completedManifestSha256,completedManifest,verifyFixedFeatures} from './lib/completed-baseline.mjs';
